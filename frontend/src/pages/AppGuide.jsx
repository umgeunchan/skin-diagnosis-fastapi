      ...
      <div className="px-6 py-6 text-gray-800 space-y-6">
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed">
            홈 화면 하단의 <strong>진단하기</strong> 버튼을 눌러 진단을 시작합니다.
            이후 <strong>주의사항</strong>을 확인한 후 사진을 촬영하거나 업로드할 수 있습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed">
            피부 부위가 선명하게 보이도록 <strong>후면 카메라</strong>로 촬영하거나,
            저장된 사진을 선택하여 업로드할 수 있습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed">
            제출된 이미지는 AI가 분석하며, <strong>가장 유력한 피부 질환과 확률</strong>이 화면에 표시됩니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed">
            <strong>“더 알아보기”</strong> 버튼을 눌러 해당 질환에 대한 상세 정보를 확인할 수 있고,
            <strong>“다시 진단하기”</strong> 버튼을 통해 새로운 사진으로 재진단할 수 있습니다.
          </p>
        </section>
      </div>
    </div>
